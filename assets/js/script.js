...
function wa(isi) 
{
	open("https://wa.me/6281294951963?text=Makasih banget loh udah inget hari ulang tahun gue, di hari spesial ini pendapat gue " + isi)
}
...
async function makeawish() 
{
	var {
		...
		imageUrl: 'assets/img/B/b5.jpg',
		title: 'Bagaimana Mengenai ini?',
		imageWidth: 350,
		imageHeight: 500,
	...
	if (kado) {
		await swal.fire({
			...
			title: 'Kirim jawabannya ke wa gue yaws',
			confirmButtonColor: '#2fe965',
			confirmButtonText: 'Kirim ✈'
		})
		wa(kado)
